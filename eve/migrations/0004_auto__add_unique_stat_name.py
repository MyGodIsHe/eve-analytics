...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Stat', fields ['name']
        db.create_unique('eve_stat', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Stat', fields ['name']
        db.delete_unique('eve_stat', ['name'])
