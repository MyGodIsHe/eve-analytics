...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SkipChart.value'
        db.delete_column('eve_skipchart', 'value')

        # Adding field 'SkipChart.queue_size'
        db.add_column('eve_skipchart', 'queue_size',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SkipChart.value'
        db.add_column('eve_skipchart', 'value',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Deleting field 'SkipChart.queue_size'
        db.delete_column('eve_skipchart', 'queue_size')
    ...
    models = {
        ...
        'eve.skipchart': {
            ...
            'queue_size': ('django.db.models.fields.FloatField', [], {})
        },
        'eve.solarsystem': {
