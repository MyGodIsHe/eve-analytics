...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SkipChart.packages'
        db.add_column('eve_skipchart', 'packages',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SkipChart.packages'
        db.delete_column('eve_skipchart', 'packages')
    ...
    models = {
        ...
        'eve.skipchart': {
            ...
            'packages': ('django.db.models.fields.IntegerField', [], {}),
